...
class Db
{
    ...
    private static function parseDsn($dsnStr)
    {
        ...
        $dsn = [
            'type'     => isset($info['scheme'])?$info['scheme']:config('type'),
            'username' => isset($info['user']) ? $info['user'] : config('username'),
            'password' => isset($info['pass']) ? $info['pass'] : config('password'),
            'hostname' => isset($info['host']) ? $info['host'] : config('hostname'),
            'hostport' => isset($info['port']) ? $info['port'] : config('hostport'),
            'database' => !empty($info['path']) ? ltrim($info['path'], '/') : config('database'),
