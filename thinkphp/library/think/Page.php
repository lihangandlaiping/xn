...
class Page{
    ...
    private $config  = array(
        'header' => ' <p class="pull-left">共 %TOTAL_ROW% 条记录</p>',
        'prev'   => '上一页',
        'next'   => '下一页',
        'first'  => '第一页',
        'last'   => '最后一页',
        'theme'  => '<div> %HEADER% <ul class="pagination  pull-right"> %FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END% </ul> </div>',
    );
    ...
    public function show() {
        ...
        //替换分页内容
        $page_str = str_replace(array('%HEADER%', '%NOW_PAGE%', '%UP_PAGE%', '%DOWN_PAGE%', '%FIRST%', '%LINK_PAGE%', '%END%', '%TOTAL_ROW%', '%TOTAL_PAGE%'),
