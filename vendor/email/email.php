...
final class Email{
	...
	function __construct($setting_config)
    {
	 ...
	 */
	private  function send($email_to, $subject, $message, $from = ''){
    ...
    /**
     * @param $email_to 接受邮件的账号
     * @param $subject  标题
     * @param $message 类容
     * @return bool
     */
	public function send_sys_email($email_to, $subject, $message){
                   // $setting_config=C('setting_config');
		$this->set('email_server',$this->setting_config['email_host']);
		$this->set('email_port',$this->setting_config['email_port']);
		$this->set('email_user',$this->setting_config['email_id']);
		$this->set('email_password',$this->setting_config['email_pass']);
		$this->set('email_from',$this->setting_config['email_addr']);
		$this->set('site_name',$this->setting_config['site_name']);
